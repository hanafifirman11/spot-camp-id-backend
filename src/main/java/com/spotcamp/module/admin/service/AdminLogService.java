...
import com.spotcamp.module.admin.dto.LogEntryDTO;
import com.spotcamp.module.admin.dto.LogListResponseDTO;
...
public class AdminLogService {
    ...
    public LogListResponseDTO getLogs(int page, int size, String level, String search) {
        ...
        if (!logFile.exists()) {
            ...
            return LogListResponseDTO.builder().content(List.of()).build();
        }
