...
import com.spotcamp.module.visualmap.dto.MapConfigRequestDTO;
import com.spotcamp.module.visualmap.dto.MapConfigResponseDTO;
import com.spotcamp.module.visualmap.dto.MapViewResponseDTO;
...
public class MapController {
    ...
    @ApiResponses(value = {
        @ApiResponse(
            ...
            content = @Content(
                mediaType = "application/json",
                schema = @Schema(implementation = MapConfigResponseDTO.class)
            )
        ),
        @ApiResponse(
            responseCode = "400",
    ...
    public ResponseEntity<MapConfigResponseDTO> saveMapConfig(
            @Parameter(description = "Unique identifier of the campsite")
            @PathVariable Long campsiteId,
            @Valid @RequestBody MapConfigRequestDTO request
    ) {
        ...
        MapConfigResponseDTO response = MapConfigResponseDTO.builder()
                .id(saved.getId())
    ...
    @ApiResponses(value = {
        @ApiResponse(
            ...
            content = @Content(
                mediaType = "application/json",
                schema = @Schema(implementation = MapViewResponseDTO.class)
            )
        ),
        @ApiResponse(
            responseCode = "400",
    ...
    public ResponseEntity<MapViewResponseDTO> getMapView(
            @Parameter(description = "Unique identifier of the campsite")
            @PathVariable Long campsiteId,
            @RequestParam(required = false) String mapCode,
            @RequestParam(required = false) Long mapId,
        ...
        MapViewResponseDTO response = MapViewResponseDTO.builder()
    ...
    @PreAuthorize("hasAnyRole('MERCHANT_ADMIN', 'SUPERADMIN', 'ADMIN')")
    @SecurityRequirement(name = "bearerAuth")
    public ResponseEntity<MapConfigResponseDTO> activateConfig(
            @PathVariable Long campsiteId,
