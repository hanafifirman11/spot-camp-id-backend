...
import com.spotcamp.inventory.api.dto.*;
...
public class CampsiteProductController {
    ...
    public ResponseEntity<ProductListResponse> listCampsiteProducts(
        ...
        return ResponseEntity.ok(ProductListResponse.of(content, page, size, products.getTotalElements()));
    }
    ...
    public ResponseEntity<ProductResponse> createCampsiteProduct(
            @PathVariable Long campsiteId,
